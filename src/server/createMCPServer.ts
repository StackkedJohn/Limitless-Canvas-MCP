 ...
 * MCP Server Factory
 *
 * Creates an MCP server instance with all tool handlers.
 * Used by both stdio (Claude Code) and SSE (Claude Chat) transports.
 */
...
export const SERVER_NAME = 'limitless-canvas';
